          ...
          <section class="container tm-page-1-content">
            <div class="row">
              <div class="col-md-6 ml-auto tm-text-white">
                <header><h1>Tiga Dewa Adventure</h1></header>
                <p>Tiga dewa adventure merupakan sebuah travel agent yang dikhususkan untuk memberikan nuansa yang berbeda !</p>
                <h2>Lets Explore indonesia !</h2>

                  <a href="#tm-section-2" class="btn btn-danger">Explore Travel</a>
              </div>
            </div>
